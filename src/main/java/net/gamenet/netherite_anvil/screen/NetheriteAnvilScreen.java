package net.gamenet.netherite_anvil.screen;
...
public class NetheriteAnvilScreen
        extends ItemCombinerScreen<NetheriteAnvilMenu> {
    private static final ResourceLocation ANVIL_LOCATION = new ResourceLocation("textures/gui/container/anvil.png");
    private static final Component TOO_EXPENSIVE_TEXT = Component.translatable("container.repair.expensive");
    private EditBox name;
    private final Player player;

    public NetheriteAnvilScreen(NetheriteAnvilMenu anvilMenu, Inventory inventory, Component component) {
    ...
    protected void renderLabels(PoseStack poseStack, int i, int j) {
        ...
        int k = ((NetheriteAnvilMenu)this.menu).getCost();
        if (k > 0) {
            Component component;
            int l = 8453920;
            if (k >= 40 && !this.minecraft.player.getAbilities().instabuild) {
                ...
                l = 0xFF6060;
            } else if (!((NetheriteAnvilMenu)this.menu).getSlot(2).hasItem()) {
                component = null;
            } else {
                component = Component.translatable("container.repair.cost", k);
                if (!((NetheriteAnvilMenu)this.menu).getSlot(2).mayPickup(this.player)) {
                    l = 0xFF6060;
                }
            }
            if (component != null) {
                ...
                int n = 69;
                net.minecraft.client.gui.screens.inventory.AnvilScreen.fill(poseStack, m - 2, 67, this.imageWidth - 8, 79, 0x4F000000);
